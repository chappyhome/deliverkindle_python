...
Attacklab.wmdBase = function(){
    ...
    var toolbar_hyperlink_label = 'link' + " <a> Ctrl-L";
    var toolbar_blockquote_label = 'quote' + " <blockquote> Ctrl-.";
    var toolbar_code_label = 'preformatted text' + " <pre><code> Ctrl-K";
    var toolbar_image_label = 'image' + " <img> Ctrl-G";
    var toolbar_numbered_label = 'numbered list' + " <ol> Ctrl-O";
    var toolbar_bulleted_label = 'bulleted list' + " <ul> Ctrl-U";
    var toolbar_heading_label = 'heading' + " <h1>/<h2> Ctrl-H";
    var toolbar_horizontal_label = 'horizontal bar' + " <hr> Ctrl-R";
    var toolbar_undo_label = 'undo' + " Ctrl-Z";
	...
	// entering links.
	var imageDialogText = "<p style='margin-top: 0px'>" + 'enter image url' + "</p>";
	var linkDialogText = "<p style='margin-top: 0px'>" + 'enter url' + "</p>";
    var uploadImageHTML ="<div>" + 'upload image' + "</div>" +
